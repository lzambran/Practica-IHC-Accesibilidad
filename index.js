...
/*Este apartado lo agrege para darle definicion a las imagenes en el caroucel al abrir una imagen para cada punto y no se repita la primera*/
const imagenes = document.querySelectorAll('.project-img')
const imagenLight = document.querySelector('.modal-project-image');
const contenedorLight = document.querySelector('.imagen-l')
